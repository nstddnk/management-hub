...
export const QuickActionsPanel = () => {
  return (
    <div className="bg-[#1e2233] rounded-2xl border border-[#1E2737] p-3 w-full lg:max-w-[280px]" role="region" aria-label="Quick Actions">
      <h2 className="text-2xl leading-normal font-extralight mb-3 text-white">Quick actions</h2>

      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-1 gap-2" role="menu">
