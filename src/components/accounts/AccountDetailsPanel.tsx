      ...
      >
        ...
        >
          ...
          {activeItem === 'Winnability' ? (
            ...
            <div className="flex bg-[#252a3e] rounded-xl lg:rounded-2xl p-6 min-h-[200px] items-center justify-center">
              <p className="text-gray-400 text-center text-sm lg:text-base">
                Content for <span className="text-blue-400">{activeItem}</span> is not available yet
              </p>
            </div>
          )}
        </div>
