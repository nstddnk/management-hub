            ...
            >
              ...
              {activeCategoryId === id && items.length > 0 && (
                <div
                  ...
                  className="mt-2 flex flex-col gap-1 pl-2 animate-slide-down origin-top"
                  role="menu"
                >
                  {items.map((item) => (
                    <button
        ...
        >
          ...
          <div className="flex gap-4 w-full justify-between">
            <div className="flex flex-col bg-[#252a3e] justify-start gap-[14px] rounded-2xl p-4 w-full">
              <h4 className="text-white text-lg font-light">Overall Score</h4>
              <div className="flex items-center">
                <span className="text-white text-4xl font-light ">82%</span>
                <div
                  className="flex items-center border border-blue-500 rounded-full px-4 py-1 ml-2"
          ...
          >
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-center justify-between">
                ...
                <Button
                  className="ml-8 bg-green-400 hover:bg-green-500 text-black text-xs font-light rounded-full px-10 py-3 transition"
