  ...
  return (
    <div className="flex flex-col md:flex-row gap-6">
      <div className="flex-1 flex flex-col gap-6">
        ...
        <div
          className="bg-[#1e2233] rounded-2xl p-8 border border-[#ffffff14]"
          role="list"
        ...
        >
          <div className="flex items-center justify-between relative">
            ...
            {steps.map((step, index) => (
              ...
              >
                <div
                  className={`w-11 h-11 rounded-full flex items-center justify-center bg-[#1e2233] relative ${
                    step.completed
                ...
                >
                  <Check
                    className={`w-6 h-6 ${step.completed ? 'text-[#16A34A]' : 'text-[#64748B]'}`}
                  />
                </div>
      ...
      <div className="flex-1 flex flex-col gap-6">
        ...
        >
          <div className="flex flex-wrap">
            <div
              className="flex items-center gap-3 w-1/2 mb-6 pr-16"
              role="listitem"
              aria-checked="true"
            >
            ...
            <div
              className="flex items-center gap-3 w-1/2 pr-16"
              role="listitem"
              aria-checked="true"
            >
              <div className="w-6 h-6 flex items-center justify-center">
